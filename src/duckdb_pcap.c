...
// Forward declaration for the function generated by the macro
DUCKDB_EXTENSION_API bool duckdb_pcap_init_c_api(duckdb_extension_info info, struct duckdb_extension_access *access);
